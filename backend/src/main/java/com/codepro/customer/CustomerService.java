...
public class CustomerService {
    ...
    public CustomerService(@Qualifier("list") CustomerDao customerDao, PasswordEncoder passwordEncoder, CustomerDTOMapper customerDTOMapper, S3Service s3Service, S3Buckets s3Buckets) {
